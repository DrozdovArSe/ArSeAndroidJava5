...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    static final LatLng startMarker = new LatLng(52.28781, 76.98028); // Начальный маркер
    static final LatLng marker1 = new LatLng(52.29048, 76.97784); // Маркер 27 школа
    static final LatLng marker2 = new LatLng(52.29515, 76.98178); // Маркер 5 поликлиника
    static final LatLng marker3 = new LatLng(52.28857, 76.98143); // Маркер Ваш Магазин
    static final LatLng marker4 = new LatLng(52.28902, 76.98059); // Маркер детсад 72
    static final LatLng marker5 = new LatLng(52.28505, 76.98287); // Маркер Баянтау
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(marker1).title(getString(R.string.marker1_title)).icon(
                BitmapDescriptorFactory.fromResource(R.drawable.twoseven)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker2).title((getString(R.string.marker2_title))).icon(
                BitmapDescriptorFactory.fromResource(R.drawable.five)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker3).title((getString(R.string.marker3_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.vash)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker4).title((getString(R.string.marker4_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.seventwo)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker5).title((getString(R.string.marker5_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.bayant)).alpha(ALPHA).
